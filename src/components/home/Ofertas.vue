        ...
        <div class="col-lg-3">
          <div class="bbb_container">
            ...
            <div class="bbb_slider_nav">
              <div class="bbb_prev bbb_nav">
                <i class="fas fa-angle-left ml-auto"></i>
              </div>
              <div class="bbb_next bbb_nav">
            ...
            <div class="owl-carousel owl-theme bbb_slider">
              <div class="owl-item">
                <div class="bbb_item is_new">
                  ...
                  >
                    <img src="https://i.imgur.com/9XOqCSE.jpg" alt="" />
                  </div>
                  <div class="bbb_content">
                    <div class="bbb_category">
                      <a href="#">Smart Phones</a>
                    </div>
                    <div class="bbb_info clearfix">
                      <div class="bbb_name">
                        <a href="#">Alcatel Mobile</a>
                      </div>
              ...
              <div class="owl-item">
                <div class="bbb_item">
                  <div
                    class="bbb_image d-flex flex-column align-items-center justify-content-center"
                  >
                    <img src="https://i.imgur.com/PIX2bzP.jpg" alt="" />
                  </div>
                  <div class="bbb_content">
              ...
              <div class="owl-item">
                <div class="bbb_item is_new">
                  <div
                    class="bbb_image d-flex flex-column align-items-center justify-content-center"
                  >
                    <img src="https://i.imgur.com/GEvakkz.jpg" alt="" />
                  </div>
                  <div class="bbb_content">
                    <div class="bbb_category">
              ...
              <div class="owl-item">
                <div class="bbb_item is_new">
                  <div
                    class="bbb_image d-flex flex-column align-items-center justify-content-center"
                  >
                    <img src="https://i.imgur.com/u94q4wq.jpg" alt="" />
                  </div>
                  <div class="bbb_content">
              ...
              <div class="owl-item">
                <div class="bbb_item is_new">
                  <div
                    class="bbb_image d-flex flex-column align-items-center justify-content-center"
                  >
                    <img src="https://i.imgur.com/f2rCLOO.jpg" alt="" />
                  </div>
                  <div class="bbb_content">
                    <div class="bbb_category">
                      <a href="#">Mobile Phones</a>
